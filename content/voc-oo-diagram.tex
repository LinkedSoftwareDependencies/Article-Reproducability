...
\begin{tikzpicture}[
    ...
    \draw[->,thick,relation,text width=15em] (parameter) -- (blank) node [right,midway,align=right] {oo:defaultValue};
    \draw[->,thick,relation,text width=15em] (parameter) -- (boolean) node [left,midway,align=left] {oo:uniqueValue};
