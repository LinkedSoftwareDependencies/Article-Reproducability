...
\begin{tikzpicture}[
    ...
    font={\Large\itshape},
    concept/.style={text=white,font={\Large\bfseries},inner sep=10pt,align=center,rectangle,fill=gray,text width=17em},
    ...
    \node[concept, below=of am] (ame) {om:ArrayMappingEntries};
    ...
    % Concept relations
    \draw[->,thick,relation] (om) -- (ome) node [left,midway,align=center] {om:field};
